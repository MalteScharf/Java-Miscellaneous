...
public class MietpreisBerechnerTestTest extends TestCase {
    ...
    public void testTestA() {
        ...
        if (!e.hasMoreElements()) {
            ...
            assertNotNull(name + " hätte auf Grund falscher Implementierung fehlgeschlagen sollen, ist es aber nicht.", tf);
            assertTrue(name + " hätte auf Grund falscher Implementierung fehlgeschlagen sollen, ist es aber nicht.", tf.trace().contains("MietpreisBerechnerTest." + name));
            if (tf.trace().startsWith("junit.framework.AssertionFailedError: expected")) {
        ...
        if (e.hasMoreElements()) {
            ...
            assertFalse(name + " stuft richtige Implementierung als falsch ein.", tf.trace().contains("MietpreisBerechnerTest." + name));
